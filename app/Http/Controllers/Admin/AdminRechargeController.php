...
class AdminRechargeController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            $data['tongtien'] = $data['tien'] + $data['khuyenmai'];
    ...
    public function update($id, Request $request)
    {
        try {
            DB::beginTransaction();
            $rechargeHistory = LichSuNapTien::find($id);
            $rechargeHistory->tongtien = $request->tien + $request->khuyenmai;
            $rechargeHistory->khuyenmai = $request->khuyenmai;
            $rechargeHistory->ngaycapnhat = Carbon::now();
