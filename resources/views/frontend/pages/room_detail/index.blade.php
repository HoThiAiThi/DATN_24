    ...
    <div class="content">
        ...
        <div class="card b-base-info">
            ...
            <div class="post-price">
                ...
                <span class="acreage mb-price">
                    <span>Ngày cập nhật</span> {{ $room->ngaycapnhat }}
                </span>
                <span class="acreage mb-price">
        ...
        <div class="card b-user-rating">
            <div class="card-header">
                <div class="cpn-heading">Đánh giá phòng trọ</div>
            </div>
            <div class="card-body">
                <div class="user-review">
                    <div class="user-info">
                        <img src="{{ asset('images/avatar.jpg') }}" alt="Ảnh người dùng" class="user-avatar">
            ...
            <div class="card-body author">
                <div class="author-aside">
                    ...
                    <div class="author-info">
                        ...
                        <button type="button" class="btn btn-booking">Đặt phòng</button>
                        <button type="button" class="btn btn-saveBooking">Lưu phòng</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="popup-content">
            ...
            <form id="bookingForm">
                ...
                <div class="popup-actions">
                    ...
                    <button type="submit" class="btn btn-agree">Đồng ý</button>
                </div>
            </form>
        </div>
    </div>
