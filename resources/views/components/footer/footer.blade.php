    ...
    <div class="container footer-content">
        <div class="footer-nav">
            <div class="footer-col-first">
                ...
                <p style="line-height: 1.3;"><strong>30.000+</strong> tin bài trên hệ thống, và tiếp tục tăng</p>
                <p style="line-height: 1.3;"><strong>200.000+</strong> khách truy cập và <strong>hơn 2
        ...
        <div class="footer-company">
            <p class="fz-13">Email: phongtrodanang@gmail.com | Liên hệ: 0949021749</p>
        </div>
    </div>
</footer>