...
<div class="container">
    <h1 class="page-title-h1" style="display: flex;justify-content: space-between">Cho thuê phòng trọ, cho thuê nhà trọ,
        tìm
        phòng trọ <a href="{{ route('get_user.room.create') }}" title="Thêm mới" class="btn btn-sm btn-green"
            style="background-color:#10BD85">Thêm tin
            mới</a></h1>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('get.room.detail',['id' => $item->id,'slug' => $item->slug]) }}"
                            target="_blank" style="font-size: 14px;font-weight: 500;color: #0a570e;"><span
