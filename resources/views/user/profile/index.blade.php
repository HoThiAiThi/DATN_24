    ...
    <div class="auth-content">
        <form action="" method="POST" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" required placeholder="" name="sodienthoai" value="{{ $user->sodienthoai }}">
            </div>
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-green btn-submit " style="background-color: #10BD85;">Cập nhật tài
                    khoản</button>
            </div>
        </form>
    </div>
